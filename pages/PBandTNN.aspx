...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>Peun Baolo (hereafter PB) and Thong Na Nguak (TNN), are located in the Sepon region of Savannakhet Province, south-eastern Laos <cite>(Chang, Sayavongkhamdy, Cawte, & Souksavtdy, unpublished)</cite> (Fig. 1). They are both situated within the area of Lane Xang Minerals Limited’s current mining works.</p>
    <figure>
