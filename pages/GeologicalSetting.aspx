...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>The Sepon region is situated along the Truong Son Fold Belt, a NW-trending track of folded Palaeozoic sedimentary rocks with major granite intrusion which occupies north-centre of Laos and extends eastward into central Vietnam (Workman, 1997, p. 496). The style of mineralisation in the Sepon district and its mining potential was recognised in 1990 when copper and gold lodes covering a variety of primary and secondary types were first documented <cite>Manini & Albert, online</cite>. <p>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RightSidebar" Runat="Server">
    <asp:Label ID="lblReferenceTitle" runat="server" Text="test"></asp:Label>
</asp:Content>
