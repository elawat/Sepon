...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <script>
    ...
    <p>See <a class="download" target="_blank" href="../download/An investigation of the metallurgical material from Peun Baolo and Thong Na Nguak.pdf">the attachment</a> for the full details on the results of crucible slag analysis. The below report gives an overview of the bulk composition of crucible slag.</p>
